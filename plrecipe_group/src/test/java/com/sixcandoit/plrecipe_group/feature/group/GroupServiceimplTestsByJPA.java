...
public class GroupServiceimplTestsByJPA {
    ...
    public void 그룹_이름_수정_테스트(){
        GroupEntity group = entityManager.find(GroupEntity.class,6);
        ...
        Assertions.assertEquals(groupNameChange,entityManager.find(GroupEntity.class,6).getGroupName());
    }

    @Test
    public void 그룹_삭제_테스트(){

        GroupEntity groupToRemove = entityManager.find(GroupEntity.class, 11);
        ...
        GroupEntity removeMenu = entityManager.find(GroupEntity.class, 11);
