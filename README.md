...
1. 서비스 등록: 서비스 인스턴스가 시작될 때, 해당 서비스를 Eureka 서버에 등록합니다.

2. 서비스 검색: 클라이언트 애플리케이션이 다른 서비스 인스턴스의 위치를 검색할 수 있습니다. 이를 통해 클라이언트는 동적으로 서비스 위치를 찾아서 통신할 수 있습니다.

3. 서비스 상태 감시: Eureka는 등록된 서비스 인스턴스들의 상태를 주기적으로 감시하고, 문제가 발생한 인스턴스들을 자동으로 감지하고 제거할 수 있습니다.
