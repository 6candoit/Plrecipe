...
//
//        member.setMemberEmail("chomuckbab@naver.com");
...
//
//        Member member = entityManager.find(Member.class, "kim123@kakao.com");
//
//        String withdrawalDate = "2024.03.02";
...
//        }
//
//        Assertions.assertEquals(withdrawalDate, entityManager.find(Member.class, "kim123@kakao.com").getWithdrawalDate());
