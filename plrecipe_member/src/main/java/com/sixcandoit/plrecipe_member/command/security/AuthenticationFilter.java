...
import com.sixcandoit.plrecipe_member.command.vo.RequestLogin;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public AuthenticationFilter(AuthenticationManager authenticationManager, CommandMemberService commandMemberService, Environment environment) {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        RegisterDTO userDetails = commandMemberService.getUserDetailsByEmail(memberEmail);
