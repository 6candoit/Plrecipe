...
import com.sixcandoit.plrecipe_member.command.repositoty.MemberRepository;
...
public class CommandMemberServiceImpl implements CommandMemberService {
    ...
    public CommandMemberServiceImpl(ModelMapper mapper, MemberRepository memberRepository,
